...
void show_help (void)
{
  ...
  printf(
    ...
    "\n"
    "   cam_role - (default=\"\")\n"
    "        Must Set sts when use tmp credentials to mount tencentyun cos bucket"
    "\n"
    "   tmp_credentials_url  (default=\"\")\n"
    "        Set the sts agent url such as http://x.x.x.x/credentials/yyyy which return the struct \n"
    "        {\"TmpSecretId\":\"xx\", \"TmpSecretKey\":\"xx\",\"Token\":\"\", \"Expiration\":\"2023-08-30T19:54:18Z\"} "
    "\n"
    "FUSE/mount Options:\n"
    "\n"
